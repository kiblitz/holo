    ...
    (tokens
     ((value
       (((value (Identifier ((name int)))) (section file.txt:1,0-1,3))
        ((value (Symbol (Base (Equal)))) (section file.txt:1,4-1,5))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:2,5-2,6))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:3,6-3,7))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:4,5-4,6))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:5,7-5,8))
        ...
        ((value (Symbol (Non_custom Semicolon))) (section file.txt:8,2-8,3))))
      (errors ())))
    |}]
;;
    ...
    (tokens
     ((value
       (((value (Identifier ((name foo)))) (section file.txt:1,0-1,3))
        ...
        ((value (Symbol (Base (Times)))) (section file.txt:1,10-1,11))
        ...
        ((value (Symbol (Base (Div Div)))) (section file.txt:1,18-1,20))
        ((value (Identifier ((name d)))) (section file.txt:1,21-1,22))
        ((value (Symbol (Base (Pipe Greater)))) (section file.txt:1,23-1,25))
        ...
        ((value (Symbol (Base (Ampersand Ampersand))))
    ...
    (tokens
     ((value
       (((value (Definition (Module (((name monad))))))
        ...
        ((value (Symbol (Non_custom Colon))) (section file.txt:2,7-2,8))
        ((value (Symbol (Base (Tilda)))) (section file.txt:2,9-2,10))
        ((value (Identifier ((name a)))) (section file.txt:2,10-2,11))
        ((value (Symbol (Base (Minus Greater)))) (section file.txt:2,12-2,14))
        ((value (Identifier ((name b)))) (section file.txt:2,15-2,16))
        ((value (Symbol (Base (Minus Greater)))) (section file.txt:2,17-2,19))
        ((value (Identifier ((name c)))) (section file.txt:2,20-2,21))
        ((value (Symbol (Non_custom Semicolon))) (section file.txt:2,21-2,22))
        ((value (Identifier ((name bar)))) (section file.txt:3,3-3,6))
        ((value (Symbol (Non_custom Colon))) (section file.txt:3,7-3,8))
        ((value (Identifier ((name unit)))) (section file.txt:3,9-3,13))
        ((value (Symbol (Base (Minus Greater)))) (section file.txt:3,14-3,16))
        ((value (Identifier ((name unit)))) (section file.txt:3,17-3,21))
        ((value (Symbol (Non_custom Semicolon))) (section file.txt:3,21-3,22))
        ((value (Definition End)) (section file.txt:4,0-4,3))
        ((value (Symbol (Base (Equal)))) (section file.txt:4,4-4,5))
        ...
        ((value (Symbol (Base (Tilda)))) (section file.txt:5,11-5,12))
        ((value (Identifier ((name a)))) (section file.txt:5,12-5,13))
        ((value (Identifier ((name b)))) (section file.txt:5,14-5,15))
        ((value (Symbol (Base (Equal)))) (section file.txt:5,16-5,17))
        ...
        ((value (Symbol (Base (Plus)))) (section file.txt:7,8-7,9))
    ...
    (tokens
     ((value
       (((value (Identifier ((name x)))) (section file.txt:1,0-1,1))
        ((value (Symbol (Base (Equal)))) (section file.txt:1,2-1,3))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:5,2-5,3))
        ((value (Conditional Function)) (section file.txt:5,4-5,12))
        ((value (Symbol (Base (Pipe)))) (section file.txt:6,4-6,5))
        ((value (Identifier ((name _)))) (section file.txt:6,6-6,7))
        ((value (Symbol (Base (Minus Greater)))) (section file.txt:6,8-6,10))
        ((value (Identifier ((name x)))) (section file.txt:6,11-6,12))
        ((value (Symbol (Non_custom Semicolon))) (section file.txt:6,12-6,13))))
      (errors ())))
    |}]
;;
    ...
    (tokens
     ((value
       (((value (Typeful Type)) (section file.txt:1,0-1,4))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:2,15-2,16))
        ...
        ((value (Symbol (Non_custom Colon))) (section file.txt:2,31-2,32))
        ...
        ((value (Symbol (Base (Equal)))) (section file.txt:3,19-3,20))
        ((value (Identifier ((name foo)))) (section file.txt:3,21-3,24))
        ((value (Symbol (Non_custom Semicolon))) (section file.txt:3,24-3,25))))
      (errors ())))
    |}]
;;
    ...
    (tokens
     ((value
       (((value (Identifier ((name x)))) (section file.txt:1,0-1,1))
        ...
        ((value (Identifier ((name c)))) (section file.txt:1,15-1,16))
        ((value (Symbol (Non_custom Colon))) (section file.txt:1,16-1,17))
        ((value (Identifier ((name a)))) (section file.txt:1,18-1,19))
        ((value (Symbol (Base (Plus)))) (section file.txt:1,20-1,21))
        ((value (Identifier ((name b)))) (section file.txt:1,22-1,23))
        ((value (Symbol (Base (Plus)))) (section file.txt:1,24-1,25))
        ...
        ((value (Symbol (Non_custom Walrus))) (section file.txt:3,33-3,35))
